...
3. In the source code directory, run `./backend/build/ctrlpanel_backend`, or on Windows, run `./backend/build/ctrlpanel_backend.exe`
4. In your browser, visit http://127.0.0.1:1025/
...
I just want a place to use AI that is safe, respects your privacy, and uses the AI to its full potential.
